      ...
      <div style={{ background: 'var(--color-surface)', borderBottom: '1px solid var(--color-border)' }}>
        <div className="container container--wide" style={{ padding: '12px 24px' }}>
          <div className="tabs" style={{ display: 'inline-flex' }}>
            <button aria-selected={route === 'admin-dashboard'} onClick={() => dispatch({ type: 'goto', route: 'admin-dashboard' })}>Dashboard</button>
            ...
            <button aria-selected={route === 'admin-participation'} onClick={() => dispatch({ type: 'goto', route: 'admin-participation' })}>Participación</button>
